      ...
      <div className='w-screen xl:h-auto bg-cover bg-center flex flex-col gap-10 sm:gap-16 xl:justify-between bg-black bg-opacity-45 md:bg-opacity-80 xl:flex-row-reverse xl:items-center '>
        ...
        <div className='bg-black bg-opacity-30 h-auto backdrop-blur-sm lg:backdrop-blur-md py-1 pt-16 xl:pt-16 px-3 mb-3 w-full sm:mb-0 xl:max-w-[900px] 2xl:max-w-[1077px] 2xl:min-h-[1000px]'>
          <div className='flex flex-col gap-y-2 items-center text-white xl:justify-between xl:h-auto xl:mt-32'>
            ...
            {errorMessage && (
              <p className='text-red-500 text-xs font-medium font-["Montserrat"] mb-6 md:text-sm xl:text-base xl:font-medium'>{errorMessage.toUpperCase()}</p>
            )}
            {loading && (
            ...
            <p className='font-["Montserrat"] text-white text-xs text-center mb-6 md:text-sm xl:text-[20px] xl:font-extralight'>Join Bookaholic today and embark on a limitless reading adventure.</p>
            <div className='flex flex-col space-y-12 mb-10'>
              <form className='flex flex-col space-y-4' onSubmit={handleSubmit}>
                ...
                <div className="flex items-center w-52 h-9 border-[1px] border-[#909090] bg-transparent p-1 md:w-56 xl:w-[300px] xl:h-12 xl:px-3 xl:text-sm">
                  <label htmlFor="file-upload" className="cursor-pointer text-white font-['Montserrat'] font-bold text-xs">
