...
const Login = () => {
    ...
    return (
        <div className='w-screen h-screen bg-cover bg-center flex flex-col-reverse items-center justify-between' style={{ backgroundImage: `url(${bg})` }}>
            <div className='w-screen h-screen bg-cover bg-center flex flex-col-reverse justify-between bg-black bg-opacity-45 md:bg-opacity-80 xl:flex-row xl:items-center'>
                <div className='flex flex-col mt-10 space-y-3 pl-5 pt-2 lg:ml-20 xl:ml-0 xl:px-5 xl:space-y-5 pb-28 xl:pl-16'>
                ...
                <div className='bg-black bg-opacity-30 backdrop-blur-md lg:backdrop-blur-md py-3 pt-16 px-3 mb-12 w-full sm:mb-0 xl:h-screen xl:max-w-[900px] 2xl:max-w-[1077px]'>
                    <div className='flex flex-col items-center text-white xl:justify-between xl:h-full xl:pt-32'>
                        ...
                        <form className='flex flex-col space-y-12 mb-10' onSubmit={handleLogin}>
                            ...
                            <button
                                type='submit'
                                className='w-52 bg-black text-white text-xs font-bold font-["Montserrat"] py-4 border-[1px] border-white rounded-3xl xl:w-[300px] hover:bg-white hover:text-black duration-300'
                                disabled={loading}
                            >
